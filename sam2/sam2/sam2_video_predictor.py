...
class SAM2VideoPredictor(SAM2Base):
    ...
    def init_state(
        ...
        if prompt_frame_ids is not None:
            final_states = []
            end_frame = len(images) if end_frame == 0 else min(end_frame, len(images))
            ...
            for idx in range(num_prompts):
                ...
                if clip_len == 0:
                    ...
                    cur_state["images"] = images[prompt_frame_ids[idx]: min(prompt_frame_ids[idx] + clip_len, end_frame,
                                                                            prompt_frame_ids[
                                                                                idx + 1] if idx + 1 < num_prompts else end_frame)]
