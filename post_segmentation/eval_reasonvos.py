...
if __name__ == '__main__':
    ...
    parser.add_argument("--meta_exp_path", type=str, default="data/ReasonVOS/meta_expressions.json")
    parser.add_argument("--mask_path", type=str, default="data/ReasonVOS/Annotations")
    parser.add_argument("--pred_dir", type=str, default="")
    args = parser.parse_args()
    args.pred_path = os.path.join(args.pred_dir, "seg")
    args.save_name = os.path.join(args.pred_dir, "result.json")

    queue = mp.Queue()
    meta_exp = json.load(open(args.meta_exp_path, 'r'))
