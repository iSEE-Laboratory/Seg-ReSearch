...
from training.sam2.training.trainer import CORE_LOSS_KEY

from training.sam2.training.utils.distributed import get_world_size, is_dist_avail_and_initialized
...
class MultiStepMultiMasksAndIous(nn.Module):
    ...
    def forward(self, outs_batch: List[Dict], targets_batch: torch.Tensor):
        ...
        for outs, targets in zip(outs_batch, targets_batch):
            if outs["multistep_pred_multimasks_high_res"][0].shape[1] == 1:
                continue
