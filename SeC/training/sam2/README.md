...
```python
import torch
from training.sam2.sam2.build_sam import build_sam2
from training.sam2.sam2.sam2_image_predictor import SAM2ImagePredictor
...
```python
import torch
from training.sam2.sam2.build_sam import build_sam2_video_predictor
...
```python
import torch
from training.sam2.sam2.sam2_video_predictor import SAM2VideoPredictor
